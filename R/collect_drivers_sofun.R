...
#'  simulation parameters for SOFUN. See \code{\link{rsofun::run_pmodel_f_bysite}} or
#'  \code{\link{rsofun::run_biomee_f_bysite}}.
...
#'
#' @return A \code{rsofun} input data frame (see \link{rsofun::p_model_drivers} for a detailed
