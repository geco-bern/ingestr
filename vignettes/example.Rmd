...
Available variables are described in the table below. Note the conversion factor, which is not (yet) applied by ingestr.
...
```{r}
settings_wise <- get_settings_wise(varnam = "CNrt", layer = 1:3)
```
