...
Set fAPAR by default to 1 for all observations.
```{r}
...
```{r}
# Put data into nested format
drivers <- collect_drivers_sofun(
  site_info       = siteinfo_globresp,
  params_siml    = params_siml,
  meteo          = df_meteo, 
  fapar          = df_fapar_unity,
  co2            = df_co2,
